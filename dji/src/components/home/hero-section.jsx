...
import { slides } from "../home/homeProductsData";
                ...
                <AnimatePresence mode="wait" initial={false}>
                  {active === i && (
                    ...
                    >
                      ...
                      <div className="text-5xl font-medium my-1 text-white">{s.big}</div>
                      <div className="text-xl font-medium text-white mb-6">{s.sub}</div>
